...
interface CategoryFilterProps {
  activeCategory: PlateCategory | 'All Carplates';
  onCategoryChange: (category: PlateCategory | 'All Carplates') => void;
  totalCount: number;
}

const categories: (PlateCategory | 'All Carplates')[] = [
  'All Carplates',
  '2 DIGIT',
  '3 DIGIT',
  '4 DIGIT',
...
const getCategoryColor = (category: PlateCategory | 'All Carplates', isActive: boolean) => {
  if (!isActive) {
...
export function CategoryFilter({ activeCategory, onCategoryChange, totalCount }: CategoryFilterProps) {
  return (
